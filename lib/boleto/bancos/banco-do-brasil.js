...
var BancoBrasil = (function () {
	...
	BancoBrasil.prototype.geraCodigoDeBarrasPara = function (boleto) {
		...
		if (beneficiario.getNossoNumero().length == 10) {

			campoLivre.push('00000'); // beneficiario.getCodigoBeneficiario()
			campoLivre.push(beneficiario.getCodigoBeneficiario()); // beneficiario.getAgenciaFormatada()
