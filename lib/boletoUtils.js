...
var Datas = (function () {
	...
	Datas.prototype.comDocumento = function (_documento,locate = 'brl') {
		if (locate === 'usa') {
			_documento = new Date (_documento);
		}else if(locate === 'brl'){
			_documento = moment(_documento, 'DD-MM-YYYY').toDate();
		}
	...
	Datas.prototype.comProcessamento = function (_processamento, locate = 'brl') {
		if (locate === 'usa') {
			_processamento = new Date (_processamento);
		}else if(locate === 'brl'){
			_processamento = moment(_processamento, 'DD-MM-YYYY').toDate();
		}
	...
	Datas.prototype.comVencimento = function (_vencimento, locate = 'brl') {
		if(locate == 'usa'){
			_vencimento = new Date (_vencimento);
		}else if(locate == 'brl'){
			_vencimento = moment(_vencimento, 'DD-MM-YYYY').toDate();
		}
